    ...
    self.cmdtable = {
        ...
        args =
        {
            ...
            steady = {
                ...
                type = "toggle",
                get = function() return YaHT.db.profile.steady end,
                set = function() YaHT.db.profile.steady = not YaHT.db.profile.steady end,
                order = 4,
            },
            timer = {
                type = "group",
...
function YaHT:StartCast(spellName, rank)
    ...
    if spellName == L["Aimed Shot"] then
        ...
        self.casttime = 3
        -- Cycle through buffs looking for speed effects.
        for i=1,32 do
            -- Quick Shots
    ...
    elseif spellName == L["Steady Shot"] then
        castbar = YaHT.db.profile.steady      -- Is Steady Shot in the castbar enabled in the WTF profile?
